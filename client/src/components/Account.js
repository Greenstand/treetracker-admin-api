          ...
          <Grid item xs="12" >
            ...
            <Grid container direction="column" className={classes.bodyBox} >
              ...
              <Grid item>
                ...
                <Typography className={classes.item}>{user.firstName} {user.lastName}</Typography>
              </Grid>
              <Grid item>
              ...
              <Grid item xs="8" >
                <Grid container justify="space-between" >
                  ...
                  <Grid item  >
                    <Grid container justif="center" alignItems="center" className={classes.changeBox} >
              ...
              <Grid item>
                <Box height={20} />
                <Button color="secondary" variant="contained" className={classes.logout} >LOG OUT</Button>
              </Grid>
            </Grid>
          </Grid>
        </Grid>
