...
storiesOf('Utilities', module)
	.add('confirm', () => {
			function handleClick(){
				confirm(
					'To delete somthing',
					'You can not undo this operation, are you sure?'
				).then(result => {
					if(result){
			...
			<ThemeProvider theme={themeNew} >
				<h1>confirm box</h1>
				<p>a easy way to show confirm box, just call:
					<pre>
						confirm('your confirm box title', 'your message')
					</pre>
				</p>
				<button
					onClick={handleClick}
	...
	.add('alert', () => {
			...
			<ThemeProvider theme={themeNew} >
				<h1>alert box</h1>
				<p>a easy way to show alert box, just call:
					<pre>
						alert('your box title', 'your message')
					</pre>
				</p>
				<button
					onClick={handleClick}
	...
	.add('notification', () => {
			...
			<ThemeProvider theme={themeNew} >
				...
				<p>a easy way to show notification box, just call:
					<pre>
						notification('your box title', message Type, delay)
					</pre>
				</p>
				<button
